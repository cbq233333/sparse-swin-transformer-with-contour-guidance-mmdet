...
class LoadImageFromFile:
    ...
    def __call__(self, results):
        ...
        # if results['img_prefix_edge'] is not None:
        #     filename_edge = osp.join(results['img_prefix_edge'],
        #                         results['img_info']['filename'])
        ...
        # img_bytes_edge = self.file_client.get(filename_edge)
        # img_edge = mmcv.imfrombytes(
        #     img_bytes_edge, flag=self.color_type, channel_order=self.channel_order)
        # if self.to_float32:
        ...
        results['img'] = img
        #results['img_edge'] = img_edge
        results['img_shape'] = img.shape
        results['ori_shape'] = img.shape
        results['img_fields'] = ['img']
        #results['img_edge_fields'] = ['img_edge']
        return results
