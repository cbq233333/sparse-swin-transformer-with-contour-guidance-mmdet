...
class BaseDenseHeadEdge(BaseModule, metaclass=ABCMeta):
    """Base class for DenseHeads."""

    def __init__(self, init_cfg=None):
        super(BaseDenseHeadEdge, self).__init__(init_cfg)

    def init_weights(self):
        super(BaseDenseHeadEdge, self).init_weights()
