...
from .base_dense_head_edge import BaseDenseHeadEdge, BaseDenseHeadEdge
from .dense_test_mixins import BBoxTestMixin


@HEADS.register_module()
class AnchorFreeHeadEdge(BaseDenseHeadEdge, BBoxTestMixin):
    ...
    def __init__(self,
                 ...
                 init_cfg=dict(
                     ...
                     override=dict(
                         ...
                         std=0.01,
                         bias_prob=0.01))):
        super(AnchorFreeHeadEdge, self).__init__(init_cfg)
