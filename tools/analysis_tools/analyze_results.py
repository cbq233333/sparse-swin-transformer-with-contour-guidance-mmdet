...
def parse_args():
    ...
    parser.add_argument('--config', default='./configs/centernet/centernet_resnet18_140e_coco.py' ,help='test config file path')
    parser.add_argument(
        '--prediction_path', default= './work_pkl/centernet_HRSID.pkl', help='prediction path where test pkl result')
    parser.add_argument(
        '--show_dir', default='./show_dirs/centernet_HRSID/', help='directory where painted images will be saved')
