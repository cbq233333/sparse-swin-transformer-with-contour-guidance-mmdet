...
def add_plot_parser(subparsers):
    ...
    parser_plt.add_argument(
        ...
        type=str,
        nargs='+',
        default=['./work_dirs/work_aa_fcos_new/deswin_conv_sample_edge_HRSID/20220704_154546.log.json'],
        help='path of train log in json format')
    parser_plt.add_argument(
        '--keys',
        type=str,
        nargs='+',
        default=['loss','loss_cls','loss_bbox','loss_centerness','loss_edge','loss_bitimg'],
    ...
    parser_plt.add_argument(
        ...
        type=str,
        nargs='+',
        default=['loss','loss_cls','loss_bbox','loss_centerness','loss_edge','loss_shape'],
        help='legend of each plot')
    parser_plt.add_argument(
        '--backend', type=str, default=None, help='backend of plt')
    parser_plt.add_argument(
        '--style', type=str, default='dark', help='style of plt')
    parser_plt.add_argument('--out', type=str, default='loss_plot2.png')
