...
def parse_args():
    ...
    parser.add_argument('--config', default='./configs/aa_fcos_new/deswin_conv_sample_edge.py',help='test config file path')
    parser.add_argument('--checkpoint', default='./work_dirs/work_aa_fcos_new/deswin_conv_sample_edge_HRSID/epoch_200.pth', help='checkpoint file')
    parser.add_argument(
        '--repeat-num',
        type=int,
        default=1,
